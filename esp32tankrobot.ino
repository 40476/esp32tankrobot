 ...
 const int REACH_MIDDLE_IN1 = 21;
 const int REACH_MIDDLE_IN2 = 22;
 ...
 // ===== BLE CALLBACK CLASSES (defined after variables) =====
 ...
 // ===== BLE FUNCTION (defined after classes) =====
 ...
 void setup() {
   ...
   pServer->setCallbacks(new MyBLEServerCallbacks());  // Use renamed class
   ...
   pTxCharacteristic->setCallbacks(new MyBLECharacteristicCallbacks());  // Use renamed class
